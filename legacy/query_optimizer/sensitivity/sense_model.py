...
class sensitivity_model:
    ...
    def gen_calib_data(self,train_x,train_y,train_loss,balance=False,test_size=0.02):
        ...
        train_x, calib_x, train_labels, calib_labels = train_test_split(train_x, train_labels, test_size=test_size, shuffle=False)
        train_x, calib_un_x, train_labels, calib_un_labels = train_test_split(train_x, train_labels, test_size=test_size, shuffle=False)
