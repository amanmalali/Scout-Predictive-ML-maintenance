...
lr=[0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01,0.01] #Might want to change this
...
class riskadvisor_model:
    ...
    def gen_calib_data(self,train_x,train_y,train_loss,balance=False,test_size=0.02):
        ...
        return train_x,train_y,train_loss,calib_over_x,calib_over_y,calib_loss,calib_un_x,calib_un_y
